/*
  ...
  - The primary key for the `HistoryLog` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - The `id` column on the `HistoryLog` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
*/
-- AlterTable
ALTER TABLE "HistoryLog" DROP CONSTRAINT "HistoryLog_pkey",
DROP COLUMN "id",
ADD COLUMN     "id" SERIAL NOT NULL,
ADD CONSTRAINT "HistoryLog_pkey" PRIMARY KEY ("id");
