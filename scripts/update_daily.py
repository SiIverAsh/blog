...
HISTORY_FILE = "data/_data/history.json"
MAX_HISTORY_DAYS = 10
...
def update_yaml():
    ...
    if raw_content:
        try:
            ...
            with open('data/_data/recommendations.yml', 'w', encoding='utf-8') as f:
                yaml.dump(data, f, allow_unicode=True)
            print("Successfully updated data/_data/recommendations.yml")
